...
exports.bvnRecords = exports.ninRecords = void 0;
exports.findNINRecord = findNINRecord;
exports.findBVNRecord = findBVNRecord;
exports.maskDataByAccessLevel = maskDataByAccessLevel;
...
// Helper functions
function findNINRecord(nin) {
    return exports.ninRecords.find(record => record.nin === nin) || null;
}
function findBVNRecord(bvn) {
    return exports.bvnRecords.find(record => record.bvn === bvn) || null;
}
// Access level data masking
function maskDataByAccessLevel(record) {
